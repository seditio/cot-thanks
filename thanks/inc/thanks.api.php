...
// 		(!Cot::$cfg['plugin']['thanks']['short']) && $th_users_list .= Cot::$R['thanks_bracket_open'] . cot_date('date_full', $t_row['th_date']) . Cot::$R['thanks_bracket_close'];
// 		($th_thanked || Cot::$usr['id'] == $t_row['th_fromuser']) && $th_thanked = true;
// 	}
// }
